                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-end justify-content-between">
                                <div class="col-5">
                                    ...
                                    <span class="badge rounded-pill border border-muted fw-bold text-muted fs-2 py-1">+23%
                                        last
                                        month</span>
                                </div>
                                <div class="col-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center justify-content-between pt-4">
                                <div class="col-5">
                                    ...
                                    <span class="badge rounded-pill border border-muted fw-bold text-muted fs-2 py-1">+18%
                                        last
                                        month</span>
                                </div>
                                <div class="col-5">
