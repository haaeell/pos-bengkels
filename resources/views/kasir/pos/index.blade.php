                    ...
                    <div class="d-flex flex-column">
                        <div class="form-check mb-2">
                            ...
                            <label class="form-check-label" for="payment-cash">
                                <iconify-icon icon="material-symbols:attach-money-rounded" class="fs-5 me-2"></iconify-icon>
                                Tunai
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="payment-method" id="payment-bank-transfer" value="bank_transfer">
