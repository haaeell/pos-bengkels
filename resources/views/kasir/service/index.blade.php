            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="customer-phone" placeholder="Masukkan no telepon">
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3 mt-2">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="transaction-type"
                                            id="lunas" value="cash">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="transaction-type"
                                            id="hutang" value="bank_transfer">
                                        <label class="form-check-label" for="hutang">
                                            <iconify-icon icon="" class="fs-5 me-2"></iconify-icon>
                                            Hutang
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="mb-3">
                        <label for="lack-paid" class="form-label">Kekurangan</label>
                        <input type="text" class="form-control" readonly id="lack-paid">
                    </div>
